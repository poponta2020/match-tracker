...
class MatchServiceMemoNotificationTest {
    ...
    class NotificationSent {
        ...
        void notifiesMentorsWhenParticipantUpdatesMemo() {
            ...
            matchService.updateMatch(1L, 1L, 5, 1L, "更新されたメモ", null);
    ...
    class NotificationNotSent {
        ...
        void skipsWhenPlayerIdIsNotParticipant() {
            ...
            when(matchRepository.save(any(Match.class))).thenReturn(testMatch);
            when(playerRepository.findAllById(any())).thenReturn(List.of(player1, player2));
            // winnerId validation: updatedBy=999L is not player1/player2, but winnerId must be a player
            // Use player1 as winnerId, player 999 as updatedBy
            // updateMatch validates winnerId is a participant, so we must use a valid winnerId

            matchService.updateMatch(1L, 1L, 5, 999L, "悪意のあるメモ", null);
        ...
        void doesNotNotifyWhenMemoUnchanged() {
            ...
            matchService.updateMatch(1L, 1L, 5, 1L, "同じメモ", null);
        ...
        void doesNotNotifyWhenMemoIsNull() {
            ...
            matchService.updateMatch(1L, 1L, 5, 1L, null, null);
        ...
        void doesNotNotifyWhenMemoIsBlank() {
            ...
            matchService.updateMatch(1L, 1L, 5, 1L, "   ", null);
