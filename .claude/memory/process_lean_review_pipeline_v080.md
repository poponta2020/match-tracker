...
description: devflow v0.8.0 でレビューパイプラインを軽量化（AC適合・追加code-review・/verify を標準ループから除外、pass即終了）。PR#1033 の実測に基づく判断と再装着条件の記録
metadata:
  type: project
---
...
5. 受け側: CLAUDE.md 開発フロー行・project-profile.md の低リスクパス説明を追随更新
