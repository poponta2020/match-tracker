...
- 起動コマンド:
```bash
cd c:/Users/user/match-tracker/karuta-tracker && DB_URL="<CLAUDE.local.md の DB_URL>" DB_USERNAME="<CLAUDE.local.md の DB_USERNAME>" DB_PASSWORD="<CLAUDE.local.md の DB_PASSWORD>" ./gradlew bootRun 2>&1
```
