...
- 起動コマンド:
```bash
cd c:/Users/popon/match-tracker/karuta-tracker && DB_URL="jdbc:postgresql://dpg-d6c3rgn5r7bs73an03pg-a.oregon-postgres.render.com:5432/karuta_tracker" DB_USERNAME="karuta" DB_PASSWORD="tQMNFG3XxpSo4CpFWipGwhInXMo2uv5N" ./gradlew bootRun 2>&1
```
