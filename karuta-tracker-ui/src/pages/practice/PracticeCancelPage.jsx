...
const PracticeCancelPage = () => {
  ...
  // そのセッションでキャンセル可能な試合（WON / PENDING）を取得
  // PENDING は抽選未実行（フェーズ1）の自分の申込で、ユーザー本人が取り消せる対象。
  ...
  const cancellableForSelected = selectedSession ? getCancellableMatches(selectedSession) : [];
